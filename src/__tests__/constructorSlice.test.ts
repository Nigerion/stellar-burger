...
describe('constructorSlice', () => {
  ...
  it('should handle addIngredients bun', () => {
    const ingredient = {
    ...
    expect(newState.constructorItems.bun).toEqual(ingredient);
  });
  ...
  it('should handle clearBurger', () => {
    ...
    const newState = constructorReducer(initialState, clearBurger());
  ...
  it('should handle moveDown', () => {
    ...
    const newState = constructorReducer(initialState, moveDown(0));
